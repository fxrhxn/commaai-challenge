  ...
  initMap(){
    ...
    var padded_points = new Array(); //To store the padded array of points
        ...
        this.map = new google.maps.Map(this.refs.map, {
             center: new google.maps.LatLng(this.props.mapData.coords[0].lat, this.props.mapData.coords[0].lng),
             zoom: 6,
             mapTypeId: google.maps.MapTypeId.ROADMAP
         });

         var latLng = new google.maps.LatLng(this.props.mapData.coords[0].lat, this.props.mapData.coords[0].lng);
    ...
    marker.setPosition(find_closest_point_on_path(e.latLng,padded_points));
      ...
      google.maps.event.addDomListener(marker, 'drag', (e) => {
        ...
        var closest_Lat = findCloseLat(e.latLng.lat(), this.props.mapData)
...
//        console.log(ui_data.speed)
      ...
      $.each(this.props.mapData.coords, function(key, cords){
...
//Find the close lat.
function findCloseLat(lat,mydata){

  var latArr = []

  mydata.coords.map(function(cords, i){
